...
```{r}
plot_GDP_vs_Income <- ggplot(data = spending_data, mapping = aes(x = personal_income, y = real_gdp)) + geom_point() + labs(x = "Personal Income (Thousands)", y = "GDP of Given Year (Trillions)", title = "How do income and GDP compare over the past 75 years in America?" ) + geom_smooth()
plot_GDP_vs_Income
```
